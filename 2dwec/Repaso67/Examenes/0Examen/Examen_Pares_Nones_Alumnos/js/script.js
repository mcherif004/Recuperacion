$(document).ready(function() {
    ...
    $("#comenzarCombate").click(function() {
        ...
        $("#seleccion").hide(); // Ocultamos la seleccion
        $("#combate").show(); // Mostramos el combate
    ...
    $("#jugarRonda").click(function() {
        ...
        // Validar selección de número y elección
        ...
        const oponenteNumero = Math.floor(Math.random() * 5) + 1; // Número aleatorio del oponente
    ...
    $("#revancha").click(function() {
        ...
        $("#comenzarCombate").prop("disabled", true);
        $("#revancha").hide();
        $("#pais").val('').change(); // Reiniciar selección de país
        $("#seleccion").show(); // Mostramos la seleccion
    });
});